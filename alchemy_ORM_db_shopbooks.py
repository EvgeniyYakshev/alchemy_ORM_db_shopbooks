...
DSN = 'postgresql://postgres:1837099@localhost:5432/alchemy_ORM_db_shopbooks'
...
pub2 = Publisher(name='Марк Твен')
pub3 = Publisher(name='Александр Солженицын')
pub4 = Publisher(name='Игорь Сенчин')
...
b1 = Book(title='Капитанская дочка', id_publisher=1)
b2 = Book(title='Том Соер', id_publisher=2)
b3 = Book(title='Гекльберри Финн', id_publisher=2)
b4 = Book(title='В первом круге', id_publisher=3)
b5 = Book(title='Дождь в Париже', id_publisher=4)
...
s1 = Shop(name='Книжный дом')
s2 = Shop(name='Буквоед')
...
writer = input('Введите ИМЯ или Идентификатор издателя (Publisher): ')
